...
export default function CreateFood() {
  ...
  const onSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    const response = await axios.post("http://localhost:8020/api/v1/food/upload", formData, {
      ...
      <div className="create-food-card">
        ...
        <form className="create-food-form" onSubmit={onSubmit}>
          ...
          <div className="flex justify-end mt-6">
            {/* //justify end works for chidlren */}
            <button
              type="submit"
              disabled={isDisabled}
              className="px-6 py-2 h-10 rounded-2xl bg-black text-sm cursor-pointer text-white font-semibold
