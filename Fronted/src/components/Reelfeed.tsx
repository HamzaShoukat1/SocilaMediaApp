...
export default function Reelfeed({ items = [], onLike, onSave, emptyMessage = 'No videos yet.' }: { items: ReelItem[], onLike?: (item: ReelItem) => void, onSave?: (item: ReelItem) => void, emptyMessage?: string }) {
    ...
    const setVideoRef = (id: any) => (el: any) => {
